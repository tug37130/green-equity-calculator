# -*- coding: utf-8 -*-
"""
Created on Tue Feb 20 11:11:21 2024
...
###
# output written to a README.txt
def write_readme(state_abbr):
    # Call recommended_plants() to get recommendations
    recommendations = recommended_plants(state_abbr)
    
    # Create or open readme.txt in write mode
    with open("readme.txt", "w") as f:
        # Write recommendations to readme.txt
        f.write("Recommended Plants for {}\n".format(state_abbr))
        f.write("================================\n\n")
...
def delete_readme():
    if os.path.exists("readme.txt"):
        ...
        print("readme.txt has been deleted.")
    else:
