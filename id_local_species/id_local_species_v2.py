# -*- coding: utf-8 -*-
"""
Created on Sun Feb 18 18:06:49 2024
...
#
def recommended_plants(state_abbr, *args):
    ...
    for arg in args:
        if arg == 'trees':
            recommendations["Trees"] = recommended_trees()[region]
        elif arg == 'wetland_plants':
            recommendations["Wetland Plants"] = recommended_wetland_plants()[region]
        elif arg == 'wildflowers':
            recommendations["Wildflowers"] = recommended_wildflowers()[region]
        else:
